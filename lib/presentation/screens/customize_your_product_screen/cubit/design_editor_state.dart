...
class DesignEditorState {
  ...
  factory DesignEditorState.initial() {
    return DesignEditorState(
      ...
      overlayImage: null,
      availableColors: [
        SellioColors.light.productBlack,
        SellioColors.light.productWhite,
        SellioColors.light.productRed,
        SellioColors.light.productGreen,
        SellioColors.light.productPink,
        SellioColors.light.productYellow,
        SellioColors.light.productBlue,
      ],

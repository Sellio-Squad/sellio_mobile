...
import 'package:sellio_mobile/presentation/screen/account/account_settings/cubit/account_settings_cubit.dart';
  ...
  void initState() {
    ...
    _phoneController.addListener(() {
      ...
      cubit.updatePhoneNumber(
        ...
        selectedCountry: cubit.state.selectedCountry!,
      );
    });

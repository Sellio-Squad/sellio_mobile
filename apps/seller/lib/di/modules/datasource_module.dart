...
import 'package:seller/data/datasource/remote/category_remote_datasource.dart';
import 'package:seller/data/datasource/remote/product_remote_datasource.dart';
import 'package:seller/data/datasource/remote/store_remote_datasource.dart';
import 'package:seller/data/datasource/remote/store_remote_datasource_impl.dart';
import 'package:seller/data/datasource/seller_order_datasource.dart';

void initDataSourceDI(GetIt sl) {
